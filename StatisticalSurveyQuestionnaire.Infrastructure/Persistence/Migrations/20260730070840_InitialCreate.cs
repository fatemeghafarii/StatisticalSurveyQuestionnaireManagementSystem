        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HouseholdCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    Address_Alley = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Households_Cities_Address_CityId",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "Answers",
                columns: new[] { "HouseholdId", "QuestionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Households_Address_CityId",
                table: "Households",
